...
$WSK_CLI -v --apihost "$APIHOST"  package update --auth "$AUTH"  --shared yes pushnotifications \
...
$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes pushnotifications/webhook "$PACKAGE_HOME/feeds/webhook.js" \
-a feed true \
...
$WSK_CLI -v --apihost "$APIHOST" action update --auth "$AUTH" --shared yes pushnotifications/sendMessage "$PACKAGE_HOME/actions/sendMessage.js" \
